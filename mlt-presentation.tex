...
\DeclareMathOperator{\Rad}{\mathscr{R}} % Rademacher
...
\DeclareMathOperator{\K}{\mathscr{K}} % set of Kernels
...
%\institute{UIUC} 
\date{\vspace{0.3in}Sham M. Kakade, Shai Shalev-Shwartz, Ambuj Tewari \newline Toyota Technological Institue-Chicago} 
\begin{document}
